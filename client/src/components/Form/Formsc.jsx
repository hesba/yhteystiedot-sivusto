                ...
                <Container>
                    <Form>
                        ...
                        <Form.Group controlId="textarea-1">
                            <Form.ControlLabel>Kuvaus</Form.ControlLabel>
                        ...
                        <Form.Group controlId="address">
                            <Form.ControlLabel>Osoite</Form.ControlLabel>
                            <Form.Control name="address" type="text" />
                        </Form.Group>
                        <Form.Group controlId="textarea-2">
                            <Form.ControlLabel>Lisätietoja</Form.ControlLabel>
                            <Form.Control rows={5} name="textarea" accepter={Textarea} />
                        </Form.Group>
                        <Form.Group>
                            <ButtonToolbar>
                                <Button appearance="ghost" color="green">Lisää uusi yritys</Button>
